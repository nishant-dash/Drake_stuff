...
drake_cc_library(
    name = "idm_controller2",
    srcs = ["idm_controller2.cc"],
    hdrs = ["idm_controller2.h"],
    deps = [
        ":generated_vectors",
        ":idm_planner2",
        ":pose_selector",
...
drake_cc_library(
    name = "mobil_planner2",
    srcs = ["mobil_planner2.cc"],
    hdrs = ["mobil_planner2.h"],
    deps = [
        ":generated_vectors",
        ":idm_planner",
        ":lane_direction",
...
drake_cc_library(
    name = "mobil_planner3",
    srcs = ["mobil_planner3.cc"],
    hdrs = ["mobil_planner3.h"],
    deps = [
        ":generated_vectors",
        ":idm_planner",
        ":lane_direction",
...
drake_cc_googletest(
    name = "mobil_planner2_test",
    deps = [
        "//drake/automotive:mobil_planner2",
        "//drake/automotive/maliput/dragway",
    ],
)
