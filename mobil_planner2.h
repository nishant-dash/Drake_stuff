...
template <typename T>
class MobilPlanner2 : public systems::LeafSystem<T> {
 public:
  DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(MobilPlanner2)
  ...
  explicit MobilPlanner2(const maliput::api::RoadGeometry& road,
                        bool initial_with_s);
